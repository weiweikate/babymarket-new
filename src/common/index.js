import { _attatchmentURL, _session } from './request.js'
...
export { myMixinLyMap,browserRedirect, formatTime,Trim, addCookie, editCookie, getCookieValue, reqUrl, isLogin, isEmpty, getImgs, goToDeltailPages, getUUID,userPrice,getTimes, IdentityCodeValid, validateMobile, validatePwd, validateRpwd, ordersStatus }
